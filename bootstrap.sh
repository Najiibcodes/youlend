...
echo -e "\n[💻] Loan System application running on: http://loan-system.127.0.0.1.nip.io:8080"
echo -e "[💻] Traefik dashboard accessible at: http://traefik.127.0.0.1.nip.io:8080/dashboard/#/"
